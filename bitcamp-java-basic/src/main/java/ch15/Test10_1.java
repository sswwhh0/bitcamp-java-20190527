...
public class Test10_1 {
  public static void main(String[] args) {
    ...
    // => put() 메서드는 key로 넘겨받은 객체ㄴ에 대해 hashCode()를 호출하여 
    //    정수 값을 얻는다.
    ...
    // 결론!
    // => k2와 k6는 다른 객체지만, 내용물은 같고, equals()의 리턴 값이 true이기 때문에
    //    두 객체는 같은 key로 간주된다.
